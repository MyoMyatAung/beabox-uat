...
import vaimg from "@/assets/createcenter/vaimg.png";

const ViewAll = () => {
  const navigate = useNavigate();
  return (
    <div className="vabg relative w-full h-[246px] flex justify-between items-center flex-col rounded-[20px]">
      ...
      <div className="w-full px-2 z-50">
        ...
        {/* <p className="text-[24px] font-extrabold">Ranking</p> */}
      </div>
      <div className=""></div>
