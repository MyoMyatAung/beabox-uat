...
const CountdownCircle: React.FC<CountdownCircleProps> = ({ countNumber }) => {
  ...
  return (
    <div className="relative w-[100px] h-[100px] rounded-full overflow-hidden shadow-lg">
      {/* Gradient background */}
      <div 
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="text-white text-3xl font-bold" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>
          x{countNumber}
        </span>
      </div>
    </div>
