...
export const homeApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        followStatus: builder.mutation<
            void,
            { follow_user_id: any; status: any }
        >({
        ...
        replyList: builder.mutation<
            void,
            { comment_id: any; last_reply_id: any }
        >({
        ...
        getNotifications: builder.query<any, {}>({
            query: () => convertToSecureUrl(`/notification/check-noti-message`),
        }),
