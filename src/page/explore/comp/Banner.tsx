...
//                 target="_blank"
//                 key={index}
//                 className={`flex justify-center items-center px-[8px] flex-col relative bg-[#16131C] ${
//                   selectedIndex === index
//                     ? "w-[332px] h-[162px]" // Active slide size
//                     : "w-[290px] h-[148px]" // Non-active slide size
//                 }`}
//               >
//                 <img
//                   className="rounded-md transition-all duration-300 object-cover w-[332px] h-[162px]"
//                   src={cc.image}
//                   alt={`Slide ${index + 1}`}
//                 />
//               </a>
            ...
            {ad.map((cc: any, index: number) => (
              <SwiperSlide key={index}>
                <a
                  href={cc.url}
                  target="_blank"
                  className={`flex justify-center items-center px-[8px] flex-col relative transition-all duration-300 ${
                    selectedIndex === index
