...
const PasswordSetUpPopUp = () => {
  ...
  if (!isEnabledDualPassword || (decoyPassword && masterPassword)) {
    return null;
  }
  ...
  return (
    <>
      <div className="absolute top-0 h-screen bg-black/80 w-screen  flex flex-col gap-4 justify-center items-center fixed top-0 z-[9999]">
              ...
              <div className="space-y-3 mb-5">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed text-left">
                    Set up two different passwords. One opens a decoy app, the
                ...
                <div className="flex items-start space-x-2">
                  <div className="w-1 h-1 bg-white rounded-full mt-3 flex-shrink-0"></div>
                  <p className="text-white/80 text-sm leading-relaxed text-left">
                    In Settings, users can set, remove, or change the password.
                  </p>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  <div className="w-1 h-1 bg-white rounded-full mt-3 flex-shrink-0"></div>
                  <p className="text-white/80 text-sm leading-relaxed text-left">
                    You need to clean up app data to restore password
