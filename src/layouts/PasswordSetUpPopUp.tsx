...
const PasswordSetUpPopUp = () => {
    ...
    useEffect(() => {
        ...
        const hasSeenPopup = localStorage.getItem("hasSeenPasswordSetupPopup");
    ...
    return (
        <>
            {isOpen && (
                <div className="absolute top-0 left-0 h-screen bg-black/80 w-screen flex flex-col gap-4 justify-center items-center fixed z-[9999]">
